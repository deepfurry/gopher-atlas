...
const messages: Record<string, string> = {
  ...
  content_version_conflict:
    'Another session changed this Draft. 自动保存已暂停，本地内容仍保留。',
  invalid_editorial_state: '状态已变化，请重新读取当前版本后操作。',
  route_conflict: '此路径已被其他内容永久保留，请修改 slug。',
  review_revision_conflict: '待审 Revision 已变化，请刷新审核队列。',
  ...
  invalid_payload: '请检查此类型的 metadata 格式及长度。',
  tag_conflict: 'Tag 名称或 slug 已存在。',
  topic_target_unpublished: 'Topic 的所有条目必须已在 CMS 发布且未归档。',
